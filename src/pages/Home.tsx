  ...
  return (
    <section className="pb-[1000px]">
      <section className="relative h-screen flex justify-center items-center py-10">
        <div
          className="absolute inset-0 bg-cover bg-center z-0 bg-image"
        />
        ...
        <motion.div
          ...
          className="absolute w-1/2 text-center z-20"
        >
          <h1 className="text-5xl font-bold mb-4 text-text">
            Hi, I'm{" "}
            <span className="text-primary animate-bounce">Chidinma Mmahi</span>
          </h1>
